...
<%
    var model = ViewBag.Model as ModImagesProductModel;
    var listEntity = ViewBag.Data as List<ModImagesProductEntity>;
%>
...
<script type="text/javascript">
    ...
    var HLController = 'ModImagesProduct';
